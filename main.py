...
os.environ["TCL_LIBRARY"] = r"C:\Users\adria\AppData\Local\Programs\Python\Python313\tcl\tcl8.6"
os.environ["TK_LIBRARY"]  = r"C:\Users\adria\AppData\Local\Programs\Python\Python313\tcl\tk8.6"
...
def add_user(users_data: list)->None:
    ...
    users_data.append(User(name=name,location=location,posts=post,img_url=img_url))
    print(users_data)
